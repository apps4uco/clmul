...
clmul is an operation that does a multiply of 2 binary integers, think long multiplication, using XOR to "add" the partial results, hence the name carry-less multiplication.
